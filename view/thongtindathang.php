<div class="inner-right">
    ...
    <?php 
        echo '<form action="index.php?act=themgiohang&idsp='.$_GET['idsp'].'&soLuong='.$_POST['soLuong'].'" method="post" style="display: flex; flex-direction: column; gap: 10px; padding: 10px;">
